...
## Purpose 
This project analyzes email marketing performance across 20 campaigns. Using SQL for data cleaning and exploration and Tableau for visualization, I evaluated engagement KPIs such as open rate, click rate, open-to-click efficiency, unsubscribe behavior, and signup trends over time. The goal was to identify what’s working, where engagement drops, and which campaigns drive the highest or lowest performance.
